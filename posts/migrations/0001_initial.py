    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='posts.tagname')),
            ],
            options={
                'db_table': 'posts_tags',
            },
        ...
        migrations.AddField(
            model_name='post',
            name='tags',
            field=models.ManyToManyField(related_name='tags', through='posts.PostTag', to='posts.tagname', verbose_name='해쉬태그'),
        ),
        migrations.AddField(
            model_name='post',
            name='writer',
